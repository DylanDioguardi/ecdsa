...
HLS_SOURCES = ../../../../krnl_vadd_test.cpp ../../../../krnl_vadd.cpp
...
$(ObjDir)/krnl_vadd_test.o: ../../../../krnl_vadd_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../krnl_vadd_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/krnl_vadd_test.d

$(ObjDir)/krnl_vadd.o: ../../../../krnl_vadd.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../krnl_vadd.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/krnl_vadd.d
